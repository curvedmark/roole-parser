...
mixin
	= '@mixin'i _ val:(properPostfix / selectorList) mq:(_ '/' _ m:mediaQueryList { return m;})? _ semicolon {
		return {
			type: 'mixin',
...
module
	= '@module'i _ sel:(classSelector / selectorInterpolation) separator:(_ 'with' _ s:list { return s; })? _ ruleList:ruleList {
		return {
			type: 'module',
